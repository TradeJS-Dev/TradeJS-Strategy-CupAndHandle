...
describe("CupAndHandle figures", () => {
  it("renders cup, handle, neckline, target, stop, pivots and entry", () => {
    const pattern: CupAndHandlePattern = {
      ...
      leftLegProgressRatio: 0.8,
      rightLegProgressRatio: 0.75,
      leftLegRealizedRange: 30,
      rightLegRealizedRange: 29,
      handleRealizedRange: 13,
      handleRangeContracts: true,
      pathQualityPassed: true,
      breakoutTimestamp: 5,
      confirmationBars: 1,
      timestamp: 6,
      close: 112,
